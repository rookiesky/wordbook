        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_title" name="title" required="" lay-verify="title" autocomplete="off" class="layui-input" value="{{ $book->title }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" name="sort_id" value="{{ $book->sort_id }}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <script type="text/plain" id="myEditor" style="width:600px;height:240px;">{!! $book->content !!}</script>
                    </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <script>
                        ...
                        layui.use(['form','layer'], function(){
                            ...
                            form.on('submit(add)', function(data){
                                ...
                                $.post('/wp-book/book/edit',{title:data.field.title,content:content,sort_id:data.field.sort_id,id:data.field.sort_id})
                                    .done(function (e) {
