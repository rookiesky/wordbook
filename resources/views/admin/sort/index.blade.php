...
@section('content')
    ...
    <div class="x-body">
        <xblock>
            <button class="layui-btn" onclick="x_admin_show('添加分类','/wp-book/sort/create',600,400)">
        ...
        <table class="layui-table layui-form">
            ...
            <tr>
                ...
                <td class="td-manage">
                    <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('编辑','/wp-book/sort/{{ $item->id }}/edit')" ><i class="layui-icon">&#xe642;</i>编辑</button>
